...
from azure.ai.agents import ConnectedAgentTool, MessageRole, ListSortOrder, ToolSet, FunctionTool
...
with agents_client:
    ...
    Base your answer on the content of each ticket. Respond with the team name and a very brief explanation.
    """
